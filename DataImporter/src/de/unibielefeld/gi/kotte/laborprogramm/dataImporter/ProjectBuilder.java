...
public class ProjectBuilder {
    ...
    public IProject buildProject(File projects, File gelImages, File excelReport) {
        // get ProjectData
        ...
        for (GelImage gi : gd.getGelImages().getGelImage()) {
            ...
            System.out.println("GelImageId: '" + gelImageId + "' Name: '" + gi.getName() + "' Label: '" + gi.getLabel() + "'");
            IGel gel = gelMap.get(gelImageId);
            if (gel == null) {
                Logger.getLogger(ProjectBuilder.class.getName()).log(Level.WARNING, "Failed to open Gel {0}", gi.getGelImageId().getId());
            } else {
