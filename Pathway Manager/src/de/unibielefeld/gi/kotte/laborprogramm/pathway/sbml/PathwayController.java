...
import de.unibielefeld.gi.kotte.laborprogramm.pathway.utils.PathwayMapper;
...
//            species.get
    ...
    private Pathway getPathway(Reaction reaction) {
        if (pathways.isEmpty()) {
            ...
            List<String> ecNumbers = PathwayMapper.getECNumbersFromNotes(reaction);
            MetacycController mc = new MetacycController();
            //TODO organism?
            mc.getEnzymesByECNumber("ecoli", ecNumbers.iterator().next());
            //TODO pathways, an denen das Enzym beteiligt ist?
            return pathways.get(0);
        }
    }
