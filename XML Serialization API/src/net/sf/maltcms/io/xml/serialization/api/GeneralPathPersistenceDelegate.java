 ...
 * @author nilshoffmann
 */
public class GeneralPathPersistenceDelegate extends PersistenceDelegate {

    @Override
    protected Expression instantiate(Object oldInstance, Encoder out) {
        if (oldInstance instanceof GeneralPath) {
            GeneralPathPersistenceUnit gppu = new GeneralPathPersistenceUnit((GeneralPath) oldInstance);
            Object[] constructorArgs = new Object[]{((GeneralPath) oldInstance)};

            return new Expression(gppu, gppu.getClass(), "new", constructorArgs);
        }
        throw new RuntimeException("Can only persist instances of java.awt.geom.GeneralPath!");
    }
    ...
    public class GeneralPathPersistenceUnit {
        ...
        public GeneralPathPersistenceUnit(GeneralPath gp) {
            path = encode(gp);
        }
