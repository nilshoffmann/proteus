 ...
 * @author nilshoffmann
 */
public class GelBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_location = 3;
    private static final int PROPERTY_name = 4;
    private static final int PROPERTY_parent = 5;
    private static final int PROPERTY_spots = 6;
    private static final int PROPERTY_virtual = 7;
