...
import de.unibielefeld.gi.kotte.laborprogramm.pathway.api.IReactionAnnotation;
import de.unibielefeld.gi.kotte.laborprogramm.pathway.api.ReactionID;
 ...
 * @author kotte
 */
public class ReactionAnnotation implements IReactionAnnotation {

    private String compartment;
    private Map<ReactionID, String> id = new EnumMap<ReactionID, String>(ReactionID.class);
