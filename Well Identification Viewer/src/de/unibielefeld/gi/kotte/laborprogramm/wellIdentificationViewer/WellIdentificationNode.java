 ...
 * @author nilshoffmann
 */
public class WellIdentificationNode extends BeanNode<IIdentification> {

    public WellIdentificationNode(IIdentification bean, Children children, Lookup lkp) throws IntrospectionException {
        super(bean,children,lkp);
    }

    public WellIdentificationNode(IIdentification bean, Children children) throws IntrospectionException {
        super(bean,children);
    }

    public WellIdentificationNode(IIdentification bean) throws IntrospectionException {
        super(bean);
    }
...
//        final IIdentification iwi = getLookup().lookup(
//                IIdentification.class);
