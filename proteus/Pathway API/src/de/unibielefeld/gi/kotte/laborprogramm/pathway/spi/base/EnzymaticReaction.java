...
import de.unibielefeld.gi.kotte.laborprogramm.pathway.api.base.IEnzymaticReaction;
import de.unibielefeld.gi.kotte.laborprogramm.pathway.api.base.EnzymaticReactionID;
...
public class EnzymaticReaction implements IEnzymaticReaction, Activatable {
    ...
    private Map<EnzymaticReactionID, String> id = new EnumMap<EnzymaticReactionID, String>(EnzymaticReactionID.class);
