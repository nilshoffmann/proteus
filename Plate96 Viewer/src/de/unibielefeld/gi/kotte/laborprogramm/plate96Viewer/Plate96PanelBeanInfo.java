 ...
 */
public class Plate96PanelBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( de.unibielefeld.gi.kotte.laborprogramm.plate96Viewer.Plate96Panel.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
